...
class Contact(Base):
    ...
    # Profile photo as a base64 data URI. The database is in-memory by default,
    # so storing the encoded image inline keeps the app self-contained.
    ...
    addresses: Mapped[list["Address"]] = relationship(
        ...
        order_by="Address.type, Address.id",
    )
...
class Address(Base):
    """A postal address belonging to a contact; a contact can have many."""
